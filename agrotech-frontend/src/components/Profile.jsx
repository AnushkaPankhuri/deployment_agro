...
//
//     useEffect(() => {
//         api.get('/api/user/profile').then((res) => setUser(res.data));
//     }, []);
//
...
//             </div>
//
//             {['username', 'email', 'phone', 'address', 'bio', 'companyname', 'businessType', 'marketRegions', 'businessLicenseNumber'].map((field) => (
//                 <div key={field}>
//                     <label>{field}</label>
//                     <input
//                         name={field}
...
// import React, { useEffect, useState } from 'react';
// import { useApi } from '../services/api'; // your custom axios wrapper
...
//         formData.append('marketRegions', user.marketRegions || '');
//         formData.append('businessLicenseNumber', user.businessLicenseNumber || '');
//         if (file) {
//             formData.append('profilePicture', file);
//         }
//
...
//             alert('Profile updated!');
//             setEditMode(false);
//             // Optionally reload updated profile
...
// function Profile() {
//     const api = useApi();
//     const { user } = useAuth(); // <-- changed here

//     const [profile, setProfile] = useState({});  // renamed from user to profile to avoid confusion
//     const [editMode, setEditMode] = useState(false);
//     const [file, setFile] = useState(null);
...
//                 .then((res) => {
//                     console.log('API GET /api/user/profile response:', res);
//                     setProfile(res.data);
//                 })
//                 .catch((err) => {
...
//                 });
//         } else {
//             console.warn('No user found, not calling API');
//         }
//     }, [user]);
